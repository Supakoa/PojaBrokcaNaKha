    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content container">
        <div class="modal-header" style="border-bottom-color:#639CB4">
            ...
            <button type="button" class="close txt-greenblue" data-dismiss="modal" aria-label="Close" id="close">
...
{{--                                    <option disabled selected>เลือกคณะ</option>--}}
        ...
        <div class="modal-footer">
            <button type="submit" form="editForm" class="btn btn-warning m-auto">บันทึก</button>
        </div>
      </div>
    </div>
  </div>
