                    ...
                    <Container>
                        <dl className="row border round">
                            ...
                            <Col className="py-2" as="dd" sm={9} md={9} lg={9}>
                                ...
                                responsive font sizes, allowing text to scale
                                more naturally across device and viewport sizes.
                                RFS can be enabled by changing the
                                $enable-responsive-font-sizes Sass variable to
                                true and recompiling Bootstrap. To support RFS,
                                we use a Sass mixin to replace our normal
                                font-size properties. Responsive font sizes will
                                be compiled into calc() functions with a mix of
                                rem and viewport units to enable the responsive
                                scaling behavior. More about RFS and its
                                configuration can be found on its
                                {/* {document.note !== null
                                ? document.note
                                : "ไม่มีข้อมูล"} */}
                            </Col>
