...
export function Useradd(props) {
    ...
    const [_insert, setInsert] = React.useState({});
    const validate = () => {};
    return (
        <div>
            <Button
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title id="modal-add-user">เพิ่มสมาชิค</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Container>
                        <Form>
...
export function Useredit(props) {
    return (
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title id="modal-edit-user">แก้ไขสมาชิค</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Container>
                    <Form>
...
export function Userdelete(props) {
    return (
        ...
        >
            <Modal.Header closeButton>
                <Modal.Title id="modal-delete-user">ลบข้อมูลสมาชิค</Modal.Title>
            </Modal.Header>
            <Modal.Body>
