...
<body class="w3-dark-gray">
    ...
    <div style="margin-left:15%;">
        ...
        <div class="w3-bar w3-green" style="border:solid;border-color:green;">
            <a class="w3-bar-item w3-blue w3-text w3-center" style="border:solid;border-color:blue;width:79%;">Page : Home</a>
            <!-- set to right -->
            <div class="w3-right">
        ...
        <!-- start body -->
        <div class="w3-container w3-card-4 w3-purple" style="border:solid;border-color:purple;height:530px" id="body">
            <h1>Body</h1>
        </div>
        <!-- end body -->
