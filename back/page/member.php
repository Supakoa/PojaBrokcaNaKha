...
<div class="w3-container-fluid w3-center w3-pink" style="margin:20px;max-height:100%;padding:30px;">
    <h1 style="color:gray;"><strong>Choose : Role</strong></h1>
    <hr>
    <button type="button" class="btn btn-outline-dark" style="margin:15px;height:300px;width:300px;font-size:50px;"><strong>Admin</strong></button>
    <button type="button" class="btn btn-outline-dark" style="margin:15px;height:300px;width:300px;font-size:50px;"><strong>Confirmer</strong></button>
    <button type="button" class="btn btn-outline-dark" style="margin:15px;height:300px;width:300px;font-size:50px;"><strong>Student</strong></button>
</div>

<div class="w3-container-fluid w3-center w3-lime" style="margin:20px;max-height:100%;padding:30px;">
    <h1 style="color:gray;"><strong>Choose : ID</strong></h1>
    <hr>
    <div class="input-group mx-auto input-group-lg" style="width:500px;">
        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
        <div class="input-group-prepend">
            <button type="button" class="btn btn-info"><strong>Search</strong></button>
        </div>
    </div>
</div>