...
//faculty
$sql_fac = " SELECT fac.name AS fname FROM fac WHERE fac_id = '$id' ";
$re_fac = mysqli_query($con, $sql_fac);
$row_fac = mysqli_fetch_array($re_fac);
?>

<div class="modal fade" id="openMaj">
    <div class="modal-dialog modal-lg" style="height: 91%;">
        <div class="modal-content" style="height: 91%;">
            <div class="modal-header">
                <h3>Open <?php echo $row_fac['fname']; ?></h3>
            </div>
            <div class="modal-body" style="overflow-y: scroll;max-height: calc(100%-150px)">
                <div class="sticky-top">
                    <button onclick="openAddCol();" class="btn btn-success shadow-lg btn-block"><i style="color:white;" class="fas fa-plus"></i></button>
                </div>
                <hr>
